...
import { IPC, type MindmapReadRequest, type MindmapReadResponse } from '../ipc.js'
...
export class MindmapReadRequester {
  ...
  request(fileUuid: string): Promise<string> {
    ...
    return new Promise<string>((resolve, reject) => {
      ...
      const request: MindmapReadRequest = { requestId, fileUuid }
