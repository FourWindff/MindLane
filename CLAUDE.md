...
- `electron/agent/tools` contains tool implementations: mindmapActions and subgraphRoutingTools.
...
- Workspace state (last opened file, recent files, active sessions, etc.) is stored in hidden metadata inside the workspace directory.
...
This project is indexed by GitNexus as **MindLane** (5944 symbols, 12398 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
